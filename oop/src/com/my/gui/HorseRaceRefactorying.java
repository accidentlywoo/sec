...
class HorseList extends Canvas{ //paint(), repaint()
	String name;
	int x = 0, y = 10; // px 단위 위치
	public HorseList(String name) {
		this.name = name;
	}
	@Override
...
public class HorseRaceRefactorying {
	JButton run, ready;
	JFrame frame;
	Container c;
	HorseList[] horses;
...
//	
	...
	public HorseRaceRefactorying() {
	}

	public HorseRaceRefactorying(JFrame frame, Container c, HorseList[] horses) {
		super();
		this.frame = frame;
		this.c = c;
		this.horses = horses;
